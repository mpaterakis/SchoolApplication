...
public class UsersSearchModel extends AbstractTableModel {

    public UsersSearchModel(Connection con, String srch, boolean all) {
        String queryStr;
        try {
            if (!all) {
    ...
    private static final String QUERY_TABLE = "select * from users";
