...
public class FindLessons extends JDialog {

    public FindLessons(Connection con, boolean modal, AbstractTableModel etb) {
        this.etb = etb;
        this.con = con;
        initComponents();
    }
    ...
    private void doSearch() {
        ...
        if (!search4.equals(null)) {
            etb = new LessonsSearchModel(con, search4, false);
            t.setModel(etb);
            t.repaint();
        }
    }
    ...
    private void doShowAll() {
        etb = new LessonsSearchModel(con, null, true);
        t.setModel(etb);
        t.repaint();
    }
